...
export default function SummaryProducts({
  ...
  const { handleSubmit, onSubmit, isLoading } = useCheckoutForm();
  ...
  return (
    <div>
      ...
      <p className="flex justify-between text-[0.9375rem] leading-[24px] font-medium uppercase text-black/50">
        total{" "}
      ...
      <p className="flex justify-between text-[0.9375rem] leading-[24px] font-medium uppercase text-black/50 mb-6">
        vat (included){" "}
        <span className="text-lg leading-normal font-bold text-black">
      ...
      <Button width="full" action={handleSubmit(onSubmit)}>
